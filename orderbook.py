...
def unittest1():
    ...
    ob.limit_order(0, 50, 100, 'trader 1')
    ob.limit_order(1, 80, 101, 'trader 2')
    ob.limit_order(0, 20, 100, 'trader 3')
    ob.limit_order(1, 5, 105, 'trader 4')
    ob.limit_order(1, 5, 125, 'trader 5')
